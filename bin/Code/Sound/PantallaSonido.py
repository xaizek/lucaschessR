...
class WEdicionSonido(QTVarios.WDialogo):
    ...
    def __init__(self, owner, titulo, wav=None, maxTime=None, name=None):
        ...
        self.confich = Code.configuracion.ficheroDirSound
    ...
    def preparaTB(self):
        ...
        for titulo, icono, clave in li_options:
...
class WSonidos(QTVarios.WDialogo):
    def __init__(self, procesador):
        ...
        self.db = UtilSQL.DictSQL(procesador.configuracion.file_sounds(), "general")
