...
import Code
from Code.Constantes import ZVALUE_PIECE
...
class ConfigTablero(JS):
    ...
    def confPadre(self):
        if self._confPadre is None:
            self._confPadre = Code.configuracion.config_board(self._padre, self._anchoPiezaDef)
    ...
    def guardaEnDisco(self):
        Code.configuracion.cambiaConfTablero(self)
