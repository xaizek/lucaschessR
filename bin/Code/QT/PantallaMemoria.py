...
class WDatos(QtWidgets.QDialog):
    def __init__(self, wParent, txtcategoria, max_level):
...
class WMemoria(QTVarios.WDialogo):
    def __init__(self, procesador, txtcategoria, nivel, segundos, listaFen, record):
        ...
        # Tablero
        config_board = self.configuracion.config_board("MEMORIA", 48)
        ...
        tamPiezas = max(16, int(32 * self.tablero.config_board.anchoPieza() / 48))
    ...
    def repitePieza(self, from_sq):
        ...
        pieza = self.tablero.creaPieza(self.ultimaPieza, from_sq)
        pieza.activa(True)
    ...
    def comprobar(self):
        ...
        self.tablero.set_dispatcher(None)
